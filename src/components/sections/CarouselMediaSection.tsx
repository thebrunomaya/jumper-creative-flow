  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-foreground mb-2">🎠 Upload do Carrossel</h2>
        <p className="text-muted-foreground">Configure a proporção e envie as imagens para cada cartão</p>
      </div>
      ...
      <div className="bg-muted/50 border border-border rounded-lg p-4">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <p className="text-sm font-medium text-foreground">Dica para Carrossel</p>
