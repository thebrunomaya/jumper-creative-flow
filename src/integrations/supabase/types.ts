  ...
  public: {
    Tables: {
        ...
        Relationships: [
          {
            ...
            isOneToOne: false
            referencedRelation: "j_hub_optimization_recordings"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      j_hub_optimization_extracts: {
        ...
        Relationships: [
          {
            foreignKeyName: "j_hub_optimization_extracts_recording_id_fkey"
            columns: ["recording_id"]
            isOneToOne: true
            referencedRelation: "j_hub_optimization_recordings"
            referencedColumns: ["id"]
      ...
      j_hub_optimization_recordings: {
        Row: {
          ...
          shared_oracle_type: string | null
      ...
      j_hub_users: {
        ...
        Relationships: [
          {
            foreignKeyName: "j_hub_users_deactivated_by_fkey"
