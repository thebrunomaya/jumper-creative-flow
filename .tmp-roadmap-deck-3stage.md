...
### **Phase 1: Database & Backend** (Estimado: 1-2h)

- [x] **1.1** Create migration: Add stage status columns
- [x] **1.2** Create `j_hub_deck_api_logs` table
- [ ] **1.3** Refactor `j_hub_deck_generate`: Remove Stage 1 call
- [ ] **1.4** Update `j_hub_deck_generate`: Read plan from DB
- [ ] **1.5** Add API logging to both Edge Functions
- [ ] **1.6** Create `j_hub_deck_update_status` helper (optional)
- [ ] **1.7** Test Stages via Postman/curl
