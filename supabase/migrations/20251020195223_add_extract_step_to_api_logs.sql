-- Migration: Add 'extract' step to API logs constraint
-- Created: 2025-10-20
-- Purpose: Allow logging of Step 3 extract generation for admin debugging
...
BEGIN
  ...
  RAISE NOTICE 'New allowed steps: transcribe, enhance_transcription, process, analyze, extract, improve_transcript, improve_processed';
END $$;
